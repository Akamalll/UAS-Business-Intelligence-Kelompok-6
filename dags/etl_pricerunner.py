...
def transform():
    ...
    dim_cluster = df[['cluster_id']].drop_duplicates()
    dim_cluster['cluster_name'] = 'Cluster ' + dim_cluster['cluster_id'].astype(str)
    dim_cluster['cluster_description'] = 'Deskripsi cluster'
    dim_cluster['cluster_keywords'] = 'keyword1, keyword2'
    dim_cluster['cluster_size'] = 10
